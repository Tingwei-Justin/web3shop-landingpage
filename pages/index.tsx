        ...
        <div style={{
            ...
            <Container >
                ...
                <div tw="flex-grow text-white">
                    <Section id="home" style={{ minHeight: "100vh" }} tw="flex flex-col items-center relative">
                        <div tw="mt-48 font-bold relative z-10 max-w-[100rem] mx-auto flex flex-col justify-center items-start gap-8 ">
                            <div tw="text-2xl tracking-wider">
                                Welcome to the
                            </div>
                            ...
                            <div tw="flex gap-8 text-black mt-20">
                                <button tw="px-8 py-2 text-lg bg-3red rounded-full shadow-red hover:shadow-red1">
                                    SHOP IT
                                </button>
                                <button tw="px-8 py-2 text-lg bg-3blue rounded-full shadow-blue hover:shadow-blue1">
                                    SHOW IT
                                </button>
                                <button tw="px-8 py-2 text-lg bg-3green rounded-full shadow-green hover:shadow-green1">
                                    WEB3 IT
                                </button>
                            </div>
                        </div>
